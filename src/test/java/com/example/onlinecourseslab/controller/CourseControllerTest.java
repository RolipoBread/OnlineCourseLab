...
class CourseControllerTest {
	...
	@Test
	void getCourseById_NotFound_ShouldThrow() throws Exception {
		Mockito.when(courseService.getById(2L))
	...
	@Test
	void findByAuthor_ShouldReturnCourses() throws Exception {
		Course course = new Course();
		course.setId(1L);
		course.setTitle("Java");
		course.setAuthor("John");
	...
	void updateCourse_ShouldReturnUpdatedCourse() throws Exception {
		...
		Mockito.when(courseService.update(eq(1L), any(Course.class))).thenReturn(response);
